/****************************************************************************
** Meta object code from reading C++ file 'ClientManagerrr.h'
**
...
#error "The header file 'ClientManagerrr.h' doesn't include <QObject>."
...
void ClientManager::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        }
        {
            ...
            if (_t _q_method = &ClientManager::dataReceived; *reinterpret_cast<_t *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
